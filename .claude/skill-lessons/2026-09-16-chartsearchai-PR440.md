...
- `-Dtest='A+B'` with `-DfailIfNoTests=false` runs NOTHING and exits 0. Surefire wants commas. Found by a fixer only because the surefire report mtimes were 90 minutes stale.
